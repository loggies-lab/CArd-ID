        ...
        <div className="flex items-center gap-2.5">
          ...
          {currentUser ? (
            <div className="flex items-center gap-2 pl-1 border-l border-slate-800">
              <div className="flex items-center gap-2 bg-slate-900/90 border border-slate-800 rounded-xl px-2.5 py-1 text-xs">
                ...
                <div className="hidden md:block text-left leading-none">
                  <div className="text-[11px] font-medium text-slate-200 max-w-[110px] truncate">
                    {currentUser.email?.split("@")[0]}
                  </div>
                  <div className="text-[9px] font-mono text-indigo-400 uppercase tracking-wider">
              ...
              <button
                onClick={() => logout()}
                className="px-2.5 py-1.5 rounded-lg border border-slate-800 text-[11px] font-semibold text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 hover:border-rose-500/20 transition"
              >
                Sign Out
              </button>
            </div>
            ...
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-md shadow-indigo-600/20 transition active:scale-95"
            >
              Sign In
            </button>
          )}
